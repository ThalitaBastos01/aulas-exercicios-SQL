...
select * from musicas limit 12 offset 12 * (6 - 1); -- pagina 2 offset 12, pagina 3 offset 24, pagina 4 offset 36, pagina 5 offset 48, pagina 6 offset 60
...
select * from musicas where ritmo like '%troppo'; -- % é o coringa 
...
select * from musicas where composicao not ilike '%quintet%'; -- not ele é a negação de alguma condição.
